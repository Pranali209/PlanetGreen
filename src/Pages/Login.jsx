    ...
    <div className="login-bg min-h-screen flex items-center justify-center  ">
      <div className="bg-black bg-opacity-90 rounded-3xl shadow-lg w-[25rem] max-w-md px-6 py-10 flex flex-col items-start">
        ...
        <form className="w-full flex flex-col gap-4 mt-2">
          <input type="email" placeholder="Enter email address.." className="w-full px-4 py-3 rounded-md bg-[#202020] text-white placeholder-[#888787] focus:outline-none" />
          <input type="password" placeholder="Enter Password..." className="w-full px-4 py-3 rounded-md bg-[#202020] text-white placeholder-[#888787] focus:outline-none" />
